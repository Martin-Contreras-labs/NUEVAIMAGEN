...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR NUEVA PROPIEDAD EQUIPO", "")),format.raw/*8.69*/("""
		"""),format.raw/*9.3*/("""<div class="row  justify-content-md-center">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<form id="form" method="post" action="/routes2/propiedadGraba/">
					...
					<div class="noprint">
						<div class="row justify-content-md-center" >
							<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
								<input type="submit"  value="GRABAR PROPIEDAD" class="btn btn-success btn-sm rounded-pill btn-block">
							</div>
							<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
								<input type="button" value="CANCELAR" class="btn btn-light btn-sm rounded-pill btn-block" onclick="location.href='/routes2/propiedadMantencion/';">
							</div>
						</div>
					</div>
				</form>
...
"""),format.raw/*49.1*/("""<script type="text/javascript">
	...
	$(document).ready(function() """),format.raw/*51.31*/("""{"""),format.raw/*51.32*/("""
	  	"""),format.raw/*52.5*/("""document.getElementById('mostrarmostrar').style.display="block";
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuTablas/propiedadAgrega.scala.html
                  HASH: 3f23e715debaa8d81d92778322fabcac34d5d245
                  MATRIX: 1013->1|1203->98|1236->106|1252->114|1291->116|1319->119|1387->167|1415->169|1491->220|1576->285|1605->288|2883->1536|2914->1540|3005->1603|3034->1604|3066->1609|3159->1675|3187->1676
                  LINES: 28->1|33->2|35->4|35->4|35->4|37->6|37->6|38->7|39->8|39->8|40->9|76->45|80->49|82->51|82->51|83->52|84->53|84->53
                  -- GENERATED --
              */
