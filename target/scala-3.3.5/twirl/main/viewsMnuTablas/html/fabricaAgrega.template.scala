...
"""),_display_(/*7.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*7.50*/("""
	"""),format.raw/*8.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*9.4*/barraTitulo(mapDiccionario, "AGREGAR NUEVO FABRICANTE", "")),format.raw/*9.63*/("""
		"""),format.raw/*10.3*/("""<div class="row  justify-content-md-center">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<form id="form" method="post" action="/fabricaGraba/">
					...
					<div class="noprint">
						<div class="row justify-content-md-center" >
							<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
								<input type="submit"  value="GRABAR FABRICANTE" class="btn btn-success btn-sm rounded-pill btn-block">
							</div>
							<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
								<input type="button" value="CANCELAR" class="btn btn-light btn-sm rounded-pill btn-block" onclick="location.href='/fabricaMantencion/';">
							</div>
						</div>
					</div>
				</form>
...
"""),format.raw/*101.1*/("""<script type="text/javascript">
	...
	"""),format.raw/*133.2*/("""const verificaNick = (nickName) => """),format.raw/*133.37*/("""{"""),format.raw/*133.38*/("""
        ...
        $.ajax("""),format.raw/*136.16*/("""{"""),format.raw/*136.17*/("""
            """),format.raw/*137.13*/("""url: "/verificaNickFabricaAjax/",
            type: "POST",
            method: "POST",
            data: formData,
            cache: false,
            contentType: false,
	     	...
	     	success: function(respuesta)"""),format.raw/*144.36*/("""{"""),format.raw/*144.37*/("""
	     		"""),format.raw/*145.9*/("""if(respuesta=="existe")"""),format.raw/*145.32*/("""{"""),format.raw/*145.33*/("""
	     			"""),format.raw/*146.10*/("""alertify.alert('El nombre corto (nickName) del fabricante ya existe, intente con otro', function () """),format.raw/*146.110*/("""{"""),format.raw/*146.111*/("""
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuTablas/fabricaAgrega.scala.html
                  HASH: afd6fa1100701f9b38300d856035a1a3d21dd9ad
                  MATRIX: 1033->1|1260->135|1293->143|1309->151|1348->153|1376->156|1444->204|1472->206|1548->257|1627->316|1657->319|3046->1681|3069->1695|3104->1709|3299->1877|3341->1903|3380->1904|3419->1915|3462->1931|3476->1936|3504->1943|3534->1946|3548->1951|3576->1958|3627->1978|3663->1987|3773->2070|3796->2084|3831->2098|4957->3194|4989->3198|5081->3261|5111->3262|5144->3267|5238->3333|5267->3334|5343->3381|5373->3382|5404->3385|5520->3472|5550->3473|5592->3486|5843->3708|5873->3709|5910->3718|5956->3735|5986->3736|6025->3746|6091->3783|6121->3784|6161->3795|6220->3825|6250->3826|6289->3837|6319->3838|6352->3842|6382->3843|6421->3853|6639->4043|6669->4044|6705->4052|6734->4053|6771->4062|6801->4063|6833->4067|6862->4068|6894->4072|6958->4107|6988->4108|7019->4111|7136->4199|7166->4200|7208->4213|7473->4449|7503->4450|7540->4459|7592->4482|7622->4483|7661->4493|7791->4593|7822->4594|7862->4605|7924->4638|7954->4639|7993->4650|8023->4651|8060->4660|8111->4682|8141->4683|8180->4693|8246->4730|8276->4731|8316->4742|8375->4772|8405->4773|8444->4784|8474->4785|8510->4793|8539->4794|8576->4803|8606->4804|8638->4808|8667->4809|8697->4811
