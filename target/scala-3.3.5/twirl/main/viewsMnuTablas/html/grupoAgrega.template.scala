...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR/CREAR NUEVO GRUPO", "")),format.raw/*8.64*/("""
		"""),format.raw/*9.3*/("""<form action="/grupoNuevo/" method="POST">
							...
							<td>
								<div class="row">
									...
									<div class="col-xs-6 col-sm-10 col-md-10 col-lg-10">
										<input type="text" class="form-control" name="nombreGrupo" maxlength="50" onkeydown="return sinReservados(window.event)" required>
									</div>
								</div>
							</td>
						</tr>
			...
			<div class="noprint">
				<div class="row justify-content-md-center" >
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
						<input type="submit"  value="GRABAR GRUPO" class="btn btn-success btn-sm rounded-pill btn-block">
					</div>
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuTablas/grupoAgrega.scala.html
                  HASH: eee2ca51306a8e6713fc860c1f24821f92537e89
                  MATRIX: 1009->1|1199->98|1232->106|1248->114|1287->116|1315->119|1383->167|1411->169|1487->220|1567->280|1596->283|2806->1463|2838->1468|2928->1530|2957->1531|2989->1536|3082->1602|3110->1603
