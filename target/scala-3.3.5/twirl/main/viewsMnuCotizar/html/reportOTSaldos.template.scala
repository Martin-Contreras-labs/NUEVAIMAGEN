...
"""),_display_(/*4.2*/main("")/*4.10*/ {_display_(Seq[Any](format.raw/*4.12*/("""
	...
	"""),format.raw/*10.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*11.4*/barraTitulo(mapDiccionario, "SALDOS POR DESPACHAR (SOLO " + mapDiccionario.get("BODEGAS") + " VIGENTES) VS STOCK EN " + mapDiccionario.get("BODEGAS") + " INTERNAS", "FECHA: " + fechaHoy)),format.raw/*11.190*/("""
	...
	<form id="excel" class="formulario" method="post" action="/routes2/reportOtSaldosExcel/">
	</form>
...
"""),format.raw/*78.1*/("""<script type="text/javascript">
	...
	$('#tablaPrincipal').DataTable("""),format.raw/*84.33*/("""{"""),format.raw/*84.34*/("""
    	"""),format.raw/*85.6*/(""""fixedHeader": true,
    	"paging": false,
		"info": false,
		"searching": false,
    	"order": [[ 2, "asc" ]],
  ...
  """),format.raw/*93.3*/("""}"""),format.raw/*93.4*/(""" """),format.raw/*93.5*/(""");
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuCotizar/reportOTSaldos.scala.html
                  HASH: 3ff29bc5c67773bc47e1fdaa6b023ffc02ed6fa0
                  MATRIX: 1027->1|1254->135|1286->142|1302->150|1341->152|1371->157|1439->205|1473->212|1550->263|1758->449|1794->458|2849->1487|2885->1502|2915->1505|3850->2410|3880->2413|3971->2476|4000->2477|4031->2481|4124->2547|4152->2548|4217->2585|4246->2586|4279->2592|4436->2721|4465->2722|4503->2732|4606->2808|4635->2809|4665->2812|4693->2813|4721->2814|4806->2871|4835->2872|4866->2876|5042->3023|5072->3024|5115->3038|5385->3279|5415->3280|5454->3290|5558->3366|5588->3367|5627->3377|5657->3378|5689->3382|5718->3383|5751->3388
