...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR/CREAR NUEVO ESTADO "+mapDiccionario.get("Ordenes_de_trabajo").toUpperCase(), "")),format.raw/*8.121*/("""
		"""),format.raw/*9.3*/("""<form action="/otEstadoNuevo/" method="POST" onsubmit="return validarForm();">
							...
							<td>
								<div class="row">
									...
									<div class="col-xs-6 col-sm-10 col-md-10 col-lg-10">
										<input type="text" class="form-control" name="nombreEstado" maxlength="50" required>
									</div>
								</div>
							</td>
						</tr>
...
"""),format.raw/*45.1*/("""<script type="text/javascript">
	...
	const validarForm = () =>"""),format.raw/*50.27*/("""{"""),format.raw/*50.28*/("""
		"""),format.raw/*51.3*/("""$("#btnSubmit").attr('disabled',true);
		return(true);
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuCotizar/otEstadoAgrega.scala.html
                  HASH: 8e5a555ae9e71b2460e1c3fde4e6673305534943
                  MATRIX: 1013->1|1203->98|1236->106|1252->114|1291->116|1319->119|1387->167|1415->169|1491->220|1629->337|1658->340|2875->1527|2907->1532|2997->1594|3026->1595|3058->1600|3151->1666|3179->1667|3238->1698|3267->1699|3297->1702|3380->1758|3408->1759|3436->1760
                  LINES: 28->1|33->2|35->4|35->4|35->4|37->6|37->6|38->7|39->8|39->8|40->9|71->40|76->45|77->46|77->46|78->47|79->48|79->48|81->50|81->50|82->51|84->53|84->53|85->54
                  -- GENERATED --
              */
