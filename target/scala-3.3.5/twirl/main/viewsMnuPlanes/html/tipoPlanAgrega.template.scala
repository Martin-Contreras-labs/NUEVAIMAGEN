...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR/CREAR NUEVO TIPO PLAN DE MANTENCION", "")),format.raw/*8.82*/("""
		"""),format.raw/*9.3*/("""<form action="/tipoPlanNuevo/" method="POST">
			...
			<div class="noprint">
				<div class="row justify-content-md-center" >
					...
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
						<input type="button"  value="CANCELAR" class="btn btn-light btn-sm rounded-pill btn-block" onclick="location.href='/tipoPlanMantencion/';">
					</div>
				</div>
			</div>
		</form>
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuPlanes/tipoPlanAgrega.scala.html
                  HASH: e7af47119a35dbda5083ce570a3a06c10b332e2a
                  MATRIX: 1012->1|1202->98|1235->106|1251->114|1290->116|1318->119|1386->167|1414->169|1490->220|1588->298|1617->301|2814->1468|2846->1473|2936->1535|2965->1536|2997->1541|3090->1607|3118->1608
