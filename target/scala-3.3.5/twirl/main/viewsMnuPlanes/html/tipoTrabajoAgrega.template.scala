...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR/CREAR NUEVO TIPO DE TRABAJO", "")),format.raw/*8.74*/("""
		"""),format.raw/*9.3*/("""<form action="/tipoTrabajoNuevo/" method="POST">
							...
							<td>
								<div class="row">
									...
									<div class="col-xs-6 col-sm-10 col-md-10 col-lg-10">
										<input type="text" class="form-control" name="nombreTipo" maxlength="100" required>
									</div>
								</div>
							</td>
						</tr>
			...
			<div class="noprint">
				<div class="row justify-content-md-center" >
					...
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
						<input type="button"  value="CANCELAR" class="btn btn-light btn-sm rounded-pill btn-block" onclick="location.href='/tipoTrabajoMantencion/';">
					</div>
				</div>
			</div>
		</form>
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuPlanes/tipoTrabajoAgrega.scala.html
                  HASH: c849fd8c5b1c1cffca88dc3b25b3e15f0b808bb6
                  MATRIX: 1015->1|1205->98|1238->106|1254->114|1293->116|1321->119|1389->167|1417->169|1493->220|1583->290|1612->293|2807->1458|2839->1463|2929->1525|2958->1526|2990->1531|3083->1597|3111->1598
