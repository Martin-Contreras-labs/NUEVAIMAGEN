...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR/CREAR NUEVA ACTIVIDAD", "")),format.raw/*8.68*/("""
		"""),format.raw/*9.3*/("""<form action="/routes3/mantTblActividadNewSave/" method="POST">
							...
							<td>
								<div class="row">
									...
									<div class="col-xs-6 col-sm-10 col-md-10 col-lg-10">
										<input type="text" class="form-control" name="nombreActividad" maxlength="50" onkeydown="return sinReservados(window.event)" required>
									</div>
								</div>
							</td>
						</tr>
			...
			<div class="noprint">
				<div class="row justify-content-md-center" >
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
						<input type="submit"  value="GRABAR ACTIVIDAD" class="btn btn-success btn-sm rounded-pill btn-block">
					</div>
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuMantencion/mantTblActividadNew.scala.html
                  HASH: f656543543c5db7163e1db9469455cff786b2ff4
                  MATRIX: 1021->1|1211->98|1244->106|1260->114|1299->116|1327->119|1395->167|1423->169|1499->220|1583->284|1612->287|2855->1500|2887->1505|2977->1567|3006->1568|3038->1573|3131->1639|3159->1640
