...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR/CREAR NUEVO ITEM", "")),format.raw/*8.63*/("""
		"""),format.raw/*9.3*/("""<form action="/routes3/mantTblItemNewSave/" method="POST">
							...
							<td>
								<div class="row">
									...
									<div class="col-xs-6 col-sm-10 col-md-10 col-lg-10">
										<input type="text" class="form-control" name="nombreItem" maxlength="50" onkeydown="return sinReservados(window.event)" required>
									</div>
								</div>
							</td>
						</tr>
			...
			<div class="noprint">
				<div class="row justify-content-md-center" >
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
						<input type="submit"  value="GRABAR ITEM" class="btn btn-success btn-sm rounded-pill btn-block">
					</div>
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuMantencion/mantTblItemNew.scala.html
                  HASH: 3ee580993c8ca6cc65b7663789ce494766b88f0d
                  MATRIX: 1016->1|1206->98|1239->106|1255->114|1294->116|1322->119|1390->167|1418->169|1494->220|1573->279|1602->282|2825->1475|2857->1480|2947->1542|2976->1543|3008->1548|3101->1614|3129->1615
