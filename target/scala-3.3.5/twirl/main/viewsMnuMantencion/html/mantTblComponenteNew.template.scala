...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR/CREAR NUEVO COMPONENTE", "")),format.raw/*8.69*/("""
		"""),format.raw/*9.3*/("""<form action="/routes3/mantTblComponenteNewSave/" method="POST">
							...
							<td>
								<div class="row">
									...
									<div class="col-xs-6 col-sm-10 col-md-10 col-lg-10">
										<input type="text" class="form-control" name="nombreComponente" maxlength="50" onkeydown="return sinReservados(window.event)" required>
									</div>
								</div>
							</td>
						</tr>
			...
			<div class="noprint">
				<div class="row justify-content-md-center" >
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
						<input type="submit"  value="GRABAR COMPONENTE" class="btn btn-success btn-sm rounded-pill btn-block">
					</div>
					<div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuMantencion/mantTblComponenteNew.scala.html
                  HASH: 8a33dc8b5e65692b115fc75f0e12e5888e30c74e
                  MATRIX: 1022->1|1212->98|1245->106|1261->114|1300->116|1328->119|1396->167|1424->169|1500->220|1585->285|1614->288|2861->1505|2893->1510|2983->1572|3012->1573|3044->1578|3137->1644|3165->1645
