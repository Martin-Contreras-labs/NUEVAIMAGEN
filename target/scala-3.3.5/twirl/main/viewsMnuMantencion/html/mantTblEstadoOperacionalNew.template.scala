...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR/CREAR NUEVO ESTADO OPERACIONAL", "")),format.raw/*8.77*/("""
		"""),format.raw/*9.3*/("""<form action="/routes3/mantTblEstadoOperacionalNewSave/" method="POST">
							...
							<td>
								<div class="row">
									...
									<div class="col-xs-6 col-sm-10 col-md-10 col-lg-10">
										<input type="text" class="form-control" name="nombreEstado" maxlength="50" onkeydown="return sinReservados(window.event)" required>
									</div>
								</div>
							</td>
						</tr>
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuMantencion/mantTblEstadoOperacionalNew.scala.html
                  HASH: b37e5b69149759eea58733bb7c5affa3964b6436
                  MATRIX: 1029->1|1219->98|1252->106|1268->114|1307->116|1335->119|1403->167|1431->169|1507->220|1600->293|1629->296|2871->1508|2903->1513|2993->1575|3022->1576|3054->1581|3147->1647|3175->1648
