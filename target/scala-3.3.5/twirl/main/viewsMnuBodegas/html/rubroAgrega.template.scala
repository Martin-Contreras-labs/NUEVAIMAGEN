...
"""),_display_(/*6.2*/menues(mapDiccionario, mapPermiso, userMnu, " ")),format.raw/*6.50*/("""
	"""),format.raw/*7.2*/("""<div id="mostrarmostrar" style="display:none;">
		"""),_display_(/*8.4*/barraTitulo(mapDiccionario, "AGREGAR NUEVO RUBRO", "")),format.raw/*8.58*/("""
		"""),format.raw/*9.3*/("""<div class="row  justify-content-md-center">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<form id="form" method="post" action="/routes2/rubroGraba/">
					...
					<div class="noprint">
						<div class="row justify-content-md-center" >
							<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
								<input type="submit"  value="GRABAR RUBRO" class="btn btn-success btn-sm rounded-pill btn-block">
							</div>
							<div class="col-xs-6 col-sm-4 col-md-4 col-lg-4">
								<input type="button" value="CANCELAR" class="btn btn-light btn-sm rounded-pill btn-block" onclick="location.href='/routes2/rubroMantencion/';">
							</div>
						</div>
					</div>
				</form>
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/viewsMnuBodegas/rubroAgrega.scala.html
                  HASH: 19f83e8069713e7e53812f4105ca9ec9cd5d2d83
                  MATRIX: 1010->1|1200->98|1233->106|1249->114|1288->116|1316->119|1384->167|1412->169|1488->220|1562->274|1591->277|3121->1777|3152->1781|3243->1844|3272->1845|3304->1850|3397->1916|3425->1917
