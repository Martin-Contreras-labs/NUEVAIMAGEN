...
public class ReportCotizaciones {
	...
	public static List<List<String>> detallePipeline(Connection con, String db, String desdeAAMMDD, String hastaAAMMDD, String pais, String condSucursal, String condComercial) {
		...
		try {
			...
			for (Map.Entry<String, List<Double>> entry : mapDatosAux.entrySet()) {
				...
				aux.add(mesAnioOT); //15 anioMesOT
				detalle.add(aux);
	        }
	...
	public static File detallePipelineExcel(String db, Map<String,String> mapDiccionario, List<List<String>> lista1, 
		...
		try {
			...
			cell.setCellValue("REPORTE PIPELINE"+tituloSucursal);
            ...
            cell.setCellStyle(encabezado);
			cell.setCellType(Cell.CELL_TYPE_STRING);
			cell.setCellValue("AÑO MES " + mapDiccionario.get("OT"));
			...
			for(int i=0;i<lista1.size();i++){
						...
						cell.setCellStyle(detalle);
						cell.setCellType(Cell.CELL_TYPE_STRING);
						cell.setCellValue(lista1.get(i).get(15));
