...
public class FormXmlFactura {
	...
	public FormXmlFactura(String tipoDTE, String folio, String fchEmis, String periodoDesde, String periodoHasta,
	...
	public static FormXmlFactura leerArchivoXml(File fXmlFile) {
		FormXmlFactura factura = new FormXmlFactura();		
		try {
	...
	public static String grabarReferencias(String db, Map<String,String> mapPermiso, String proformaXml, FormXmlFactura factura) {
		 String xmlStr = "0"; 
		try {
			
			InputStream auxfile = Archivos.leerArchivo(db+"/"+proformaXml);
       		File fXmlFile = Archivos.parseInputStreamToFile(auxfile);
...
try{
	tmp = TempFile.createTempFile("tmp","null");
			...
			Archivos.grabarArchivo(tmp, db+"/"+proformaXml);
